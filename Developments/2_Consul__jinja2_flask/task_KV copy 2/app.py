...
# Удаляем повторяющиеся значения
    ...
    if vl != '':
        ...
        return render_template(f"base.html", title="task_KV", messg=mess, result=vl, ktl_root=ktl, data_root=keys) # выводим значение на страницу
    elif mess == '':
        return render_template(f"base.html", title="task_KV", messg=" Какой ключ!?", ktl_root=ktl, data_root=keys) # выводим значение на страницу
    else:
        return render_template(f"base.html", title="task_KV", nono=" Введите значение !", ktl_root=ktl, data_root=keys) # выводим значение на страницу
